...
import '../../css/Form.css'
class EditAdviserForm extends Component {
	constructor(props){
		super(props);
		autobind(this)
		this.state = {
			...
			choose_department: [],
			department: [],
			faculty_id: this.props.theAdviser.faculty_id,
			faculty_pos: '',
			college:'',
			first_name: this.props.theAdviser.f_name,
			middle_name: this.props.theAdviser.m_name,
			last_name: this.props.theAdviser.l_name,
			canAdd: '',
		}
	}
	...
	updateAdviser(){
		axios.post('http://localhost:3003/ischolar/update-adviser',{
			data:{
		...
		return (
			<div>
				...
				<br/>
					...
					<br/>
					<input type="text" placeholder="Middle Name" className="inputFields" maxLength="20" onChange={this.middleNameHandler} value={this.state.middle_name}/>
					<br/>

					<label>Last Name</label>
					<br/>
					<input type="text" placeholder="Last Name" className="inputFields" maxLength="20" onChange={this.lastNameHandler} value={this.state.last_name}/>
					<br/>

					<button type="button" className="add-button" onClick={this.updateAdviser}>Update Adviser</button>
